          ...
          <div className="w-full flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 p-8 flex items-center justify-center md:border-l border-slate-600/30">
              <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-extrabold text-slate-200 mb-2">خوش آمدید</h2>
                  <p className="text-slate-400">برای دسترسی به حساب کاربری خود وارد شوید</p>
                </div>
            ...
            <div className="hidden md:w-1/2 md:flex items-center justify-center p-6 bg-gradient-to-bl from-slate-800/20 to-transparent">
              <div>
                ...
                />
                <div className="mt-6 text-center">
                  <h3 className="text-xl font-medium text-cyan-400">در هر زمان و هر مکان متصل شوید</h3>
